...
var app = new Framework7({
  ...
  routes: [
    ...
    {
      path: "/favourite/",
      url: "pages/pages/favourite.html",
    },
    {
    ...
    {
      path: "/menu-list/",
      url: "pages/components/menu-list.html",
    },
    {
      path: "/author-list/",
    ...
    {
      path: "/favourite-list/",
      url: "pages/components/favourite-list.html",
    },
    {
      path: "/preloader/",
...
$$(document).on("page:init", '.page[data-name="shop-photo"]', function (e) {
  var photoBrowserDark = app.photoBrowser.create({
    photos: ["img/albums/food1.jpg", "img/albums/food2.jpg", "img/albums/food3.jpg", "img/albums/food4.jpg"],
    theme: "dark",
  });
  
  var photoBrowserDark1 = app.photoBrowser.create({
    photos: ["img/albums/menu.jpg", "img/albums/menu1.jpg", "img/albums/menu2.jpg", "img/albums/menu3.jpg"],
    theme: "dark",
  });

  $$(".shop-photo").on("click", function () {
    photoBrowserDark.open();
  });

  $$(".menu-photo").on("click", function () {
    photoBrowserDark1.open();
  });
});
...
$$('.notification-btn').on('click', function(){
  $$('.message-tab-link').removeClass('tab-link-active');
  $$('.notification-tab-link').addClass('tab-link-active');

  $$('.message-tab').removeClass('tab-active');
  $$('.notification-tab').addClass('tab-active');
});
