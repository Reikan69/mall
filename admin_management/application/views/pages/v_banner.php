                ...
                <div class="card-body p-0">
                  ...
                  <div class="row g-3">
                      ...
                      <div class="col-12 col-sm-12">
                          ...
                          <div class="" style="border: 1px solid #d4d4d4;padding: 20px;background-color: #80808063;">
                             <img id="banner" class=" w-100" style="height: 250px;" src="<?=$GLOBALS['uploads'].$dataBanner['banner_images']?>">
                          </div>
                      </div>
     ...
     <div class="card page-footer p-4 p-sm-5 px-xl-7mt-auto">
          <div class="container p-0 d-block d-sm-flex">
            ...
            <div class="d-flex align-items-center mb-4 mb-sm-0">
              ...
              <?php 
              $time = $dataBanner['banner_updated'];
                if ($time != '' || $time != null){ 
                  $times = date('M d, Y \a\t h:i A', strtotime($dataBanner['banner_updated']));
                }else{
                  $times = date('M d, Y \a\t h:i A', strtotime($dataBanner['banner_added']));
                } 
              ?>
