                ...
                <div class="card-body p-0">
                  ...
                  <div class="row g-3">
                    <div class="col-6 col-sm-6">
                       <div class="caption d-flex align-items-center mb-3 text-reset fs-8">Blog Title
                      ...
                      <input name="input_blog_title" class="form-control mb-5 mb-sm-6" type="text" <?=($action == 'add')? 'required=""': '';?> value="<?=($action != 'add')? $dataBlog['blog_title']: '';?>"  placeholder="Value">
                    </div>
                      <div class="col-6 col-sm-6">
                         ...
                         <div class="input-group">
                              <input id="datepick" class="form-control rounded-2" type="text" readonly="" value="<?=($action != 'add')? date('d F, Y h:i A', strtotime($dataBlog['blog_post'])) : '';?>">
                              <input id="datepickValue" class="form-control rounded-2" type="hidden" name="input_blog_post" value="<?=($action != 'add')? $dataBlog['blog_post'] : '';?>">
                  ...
                  <div class="row g-3">
                      <div class="col-12 col-sm-12">
                          ...
                          <div class="input-file mb-5 mb-sm-3">
                              ...
                              <input type="file" id="picInput" name="input_blog_images" >
                            ...
                            <div class="col-6 col-md-4">
                                <div class="form-check mb-4">
                                    <label class="form-check-label"><?= $val->category_name ?>
                                        <input class="form-check-input me-3" type="checkbox" name="input_blog_category[]" value="<?= $val->category_id ?>" <?= (in_array($val->category_id, explode(',', $dataBlog['blog_category']))) ? 'checked' : '' ?>>
                                    </label>
                                </div>
                            </div>
                        <?php }?>
                  ...
                  <div class="card-head d-flex align-items-center justify-content-between mb-5 mb-sm-6">
                    <div class="title title-color green">Blog Content</div>
                  </div>

                  <div id="editor"><?=($action != 'add')? $dataBlog['blog_content']: 'This is your Content';?></div>
                   <input type="hidden" id="editorContent" name="input_blog_content" value="<?=($action != 'add')? $dataBlog['blog_content']: 'This is your Content';?>">
     ...
     <div class="card page-footer p-4 p-sm-5 px-xl-7mt-auto">
          <div class="container p-0 d-block d-sm-flex">
            ...
            <div class="d-flex align-items-center mb-4 mb-sm-0">
              ...
              <?php 
              $time = $dataBlog['blog_updated'];
                if ($time != '' || $time != null){ 
                  $times = date('M d, Y \a\t h:i A', strtotime($dataBlog['blog_updated']));
                }else{
                  $times = date('M d, Y \a\t h:i A', strtotime($dataBlog['blog_added']));
                } 
              ?>
