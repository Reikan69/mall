        ...
        <div class="page-body pb-4 pb-xl-6">
          <div class="card mb-2 p-4 p-sm-5">
            ...
            <a class="btn btn-primary btn-small nav-item create"  href="<?= base_url();?>event/form/-1">
              ...
              <div class="row g-0">
                <div class="sheet-table d-block d-md-table">
                    <div class="border-bottom border-md-none d-table-row">
                        ...
                        <div class="d-none d-md-table-cell pb-4 px-3 caption">Name</div>
                        <div class="d-none d-md-table-cell pb-4 px-3 caption">Location</div>
                        <div class="d-none d-md-table-cell pb-4 px-3 caption">Start</div>
                        <div class="d-none d-md-table-cell pb-4 px-3 caption">End</div>
                    </div>
                    <?php foreach ($dataEvent as $list): ?>
                    <div class="border-bottom sheet-row position-relative d-block d-md-table-row pb-4 mb-4">
                        ...
                        <div class="col col-md-3 sheet-cell d-block d-md-table-cell py-2 py-md-4 px-0 px-md-3">
                            <a class="sheet-table-item d-flex align-items-sm-center" data-bs-toggle="modal" data-bs-target="#modal-product">
                                <div class="sheet-table-preview md-horizontal-image vertical-image flex-shrink-0">
                                    <img src="<?= $GLOBALS['uploads'].$list->event_images; ?>" alt="<?=$list->event_name;?>"/>
                                </div>
                                <div class="sheet-table-details">
                                  <div class="sheet-table-title mb-2 mb-md-1 me-8 me-md-0"><?=$list->event_name;?></div>
                       ...
                       <div class="sheet-cell col col-md-3 d-block d-md-table-cell align-middle py-2 py-md-4 px-0 px-md-3">
                          <div class="d-flex align-items-center justify-content-md-between d-md-none caption">Location</div>
                          <p><?=$list->event_location;?></p>
                        </div>
                       
                         <div class="sheet-cell col col-md-2 d-block d-md-table-cell align-middle py-2 py-md-4 px-0 px-md-3">
                          <div class="d-flex align-items-center justify-content-md-between">
                            <div class="text-neutral-4 d-none d-md-block"><?= date('M d, Y \a\t h:i A', strtotime($list->event_start)); ?></div>
                            <div class="caption d-inline-block d-md-none">Date</div>
                            <div class="caption d-block d-md-none w-50"><?= date('M d, Y \a\t h:i A', strtotime($list->event_start)); ?></div>
                          ...
                          <div class="d-flex align-items-center justify-content-md-between">
                            ...
                            <div class="table-btn-actions opacity-0 d-none d-md-flex">
                                 <div class="btn-action-small me-5">
                                      <a href="<?php echo base_url('event/form/').$list->event_id; ?>">
                                          <svg class="icon icon-edit">    
                                              <use xlink:href="#icon-edit"></use>
                                          </svg>
                                      </a>
                                  ...
                                  <div class="btn-action-small me-5">
                                      <a href="<?php echo base_url('event/deleteEvent/').$list->event_id; ?>"  onclick="return confirm('Are you sure you want to delete this event?');">
                                          <svg class="icon icon-trash">   
                                              <use xlink:href="#icon-trash"></use>
                                          </svg>
                                      </a>
