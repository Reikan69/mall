            ...
            <div class="col-lg-12 col-12 pe-lg-2">
              <div class="card mb-2 p-4 p-sm-5">
                <div class="card-head d-flex align-items-center justify-content-between mb-5 mb-sm-6">
                  ...
                  <a class="btn-stroke btn-small" href="<?=base_url('Event')?>">
                ...
                <div class="card-body p-0">
                  ...
                  <div class="row g-3">
                    <div class="col-6 col-sm-6">
                       <div class="caption d-flex align-items-center mb-3 text-reset fs-8">Event Name
                      ...
                      <input name="input_event_name" class="form-control mb-5 mb-sm-6" type="text" <?=($action == 'add')? 'required=""': '';?> value="<?=($action != 'add')? $dataEvent['event_name']: '';?>"  placeholder="Value">
                    </div>
                      <div class="col-6 col-sm-6">
                         <div class="caption d-flex align-items-center mb-3 text-reset fs-8">Date Start
                          <div class="info-tooltip ms-1" data-bs-toggle="tooltip" title="Maximum 100 characters. No HTML or emoji allowed">
                         ...
                         <div class="input-group">
                              <input id="js-daterangepick" class="form-control rounded-2" type="text" name="input_date_range" value="<?= ($action != 'add') ? date('F d, Y h:i A', strtotime($dataEvent['event_start'])) . ' - ' . date('F d, Y h:i A', strtotime($dataEvent['event_end'])) : ''; ?>">
                       ...
                       <div class="caption d-flex align-items-center mb-3 text-reset fs-8">Location
                        <div class="info-tooltip ms-1" data-bs-toggle="tooltip" title="Maximum 100 characters. No HTML or emoji allowed">
                          <svg class="icon icon-info">  
                            <use xlink:href="#icon-info"></use>
                          </svg>
                      ...
                      <input name="input_event_location" class="form-control mb-5 mb-sm-6" type="text" <?=($action == 'add')? 'required=""': '';?> value="<?=($action != 'add')? $dataEvent['event_location']: '';?>"  placeholder="Value">
                    </div>
                  <div class="row g-3">
                      <div class="col-12 col-sm-12">
                          ...
                          <div class="input-file mb-5 mb-sm-3">
                              ...
                              <input type="file" id="picInput" name="input_event_images" >
                            ...
                            <div class="col-6 col-md-4">
                                <div class="form-check mb-4">
                                    <label class="form-check-label"><?= $val->category_name ?>
                                        <input class="form-check-input me-3" type="checkbox" name="input_event_category[]" value="<?= $val->category_id ?>" <?= (in_array($val->category_id, explode(',', $dataEvent['event_category']))) ? 'checked' : '' ?>>
                                    </label>
                                </div>
                            </div>
                        <?php }?>
                  ...
                  <div class="card-head d-flex align-items-center justify-content-between mb-5 mb-sm-6">
                    <div class="title title-color green">Event Content</div>
                  </div>

                  <div id="editor"><?=($action != 'add')? $dataEvent['event_content']: 'This is your Content';?></div>
                   <input type="hidden" id="editorContent" name="input_event_content" value="<?=($action != 'add')? $dataEvent['event_content']: 'This is your Content';?>">
     ...
     <div class="card page-footer p-4 p-sm-5 px-xl-7mt-auto">
          <div class="container p-0 d-block d-sm-flex">
            ...
            <div class="d-flex align-items-center mb-4 mb-sm-0">
              ...
              <?php 
              $time = $dataEvent['event_updated'];
                if ($time != '' || $time != null){ 
                  $times = date('M d, Y \a\t h:i A', strtotime($dataEvent['event_updated']));
                }else{
                  $times = date('M d, Y \a\t h:i A', strtotime($dataEvent['event_added']));
                } 
              ?>
