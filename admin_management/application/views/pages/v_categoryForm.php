            ...
            <div class="col-lg-12 col-12 pe-lg-2">
              <div class="card mb-2 p-4 p-sm-5">
                <div class="card-head d-flex align-items-center justify-content-between mb-5 mb-sm-6">
                  ...
                  <a class="btn-stroke btn-small" href="<?=base_url('category')?>">
                ...
                <div class="card-body p-0">
                  ...
                  <input name="input_category_name" class="form-control mb-5 mb-sm-6" type="text" <?=($action == 'add')? 'required=""': '';?> value=" <?=($action != 'add')? $dataCategory['category_name']: '';?>">
     ...
     <div class="card page-footer p-4 p-sm-5 px-xl-7n7 mt-auto">
          <div class="container p-0 d-block d-sm-flex">
            ...
            <div class="d-flex align-items-center mb-4 mb-sm-0">
              ...
              <?php 
              $time = $dataCategory['category_updated'];
                if ($time != '' || $time != null){ 
                  $times = date('M d, Y \a\t h:i A', strtotime($dataCategory['category_updated']));
                }else{
                  $times = date('M d, Y \a\t h:i A', strtotime($dataCategory['category_added']));
                } 
              ?>
