        ...
        <div class="page-body pb-4 pb-xl-6">
          <div class="card mb-2 p-4 p-sm-5">
            ...
            <a class="btn btn-primary btn-small nav-item create"  href="<?= base_url();?>'shop/form/-1'">
              ...
              <div class="row g-0">
                <div class="sheet-table d-block d-md-table">
                    <div class="border-bottom border-md-none d-table-row">
                        ...
                        <div class="d-none d-md-table-cell pb-4 px-3 caption">Shop</div>
                        <div class="d-none d-md-table-cell pb-4 px-3 caption">Branches</div>
                        <div class="d-none d-md-table-cell pb-4 px-3 caption">Lot</div>
                        <div class="d-none d-md-table-cell pb-4 px-3 caption">Added</div>
                    </div>
                    <?php foreach ($dataShop as $list): ?>
                    <div class="border-bottom sheet-row position-relative d-block d-md-table-row pb-4 mb-4">
                        ...
                        <div class="col col-md-5 sheet-cell d-block d-md-table-cell py-2 py-md-4 px-0 px-md-3">
                            <a class="sheet-table-item d-flex align-items-sm-center" data-bs-toggle="modal" data-bs-target="#modal-product">
                                <div class="sheet-table-preview md-horizontal-image vertical-image flex-shrink-0">
                                    <img src="<?= $GLOBALS['uploads'].$list->shop_pic; ?>" alt="<?=$list->shop_name;?>"/>
                                </div>
                                <div class="sheet-table-details">
                                  <div class="sheet-table-title mb-2 mb-md-1 me-8 me-md-0"><?=$list->shop_name;?></div>
                                  <div class="caption w-100"><?=$list->category_name;?></div>
                                </div>
                            </a>
                        ...
                        <div class="sheet-cell d-block d-md-table-cell align-middle py-2 py-md-4 px-0 px-md-3">
                          <div class="d-inline-block d-md-none caption">Branches</div>
                          <div class="badge large green"><?=$list->shop_branches;?></div>
                        </div>
                         <div class="sheet-cell d-block d-md-table-cell align-middle py-2 py-md-4 px-0 px-md-3">
                          <div class="d-inline-block d-md-none caption">lot</div>
                          <div class="badge large"><?=$list->shop_lot;?></div>
                        </div>
                        <div class="sheet-cell col col-md-6 d-block d-md-table-cell align-middle py-2 py-md-4 px-0 px-md-3">
                          <div class="d-flex align-items-center justify-content-md-between">
                            <div class="text-neutral-4 d-none d-md-block"><?= date('M d, Y \a\t h:i A', strtotime($list->shop_added)); ?></div>
                            <div class="caption d-inline-block d-md-none">Added</div>
                            <div class="caption d-block d-md-none w-50"><?= date('M d, Y \a\t h:i A', strtotime($list->shop_added)); ?></div>
                            <div class="table-btn-actions opacity-0 d-none d-md-flex">
                                 <div class="btn-action-small me-5">
                                      <a href="<?php echo base_url('shop/form/').$list->shop_id; ?>">
                                          <svg class="icon icon-edit">    
                                              <use xlink:href="#icon-edit"></use>
                                          </svg>
                                      </a>
                                  ...
                                  <div class="btn-action-small me-5">
                                      <a href="<?php echo site_url('shop/deleteShop/').$list->shop_id; ?>"  onclick="return confirm('Are you sure you want to delete this shop?');">
                                          <svg class="icon icon-trash">   
                                              <use xlink:href="#icon-trash"></use>
                                          </svg>
                                      </a>
