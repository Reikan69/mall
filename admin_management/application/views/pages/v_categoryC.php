        ...
        <div class="page-body pb-4 pb-xl-6">
          <div class="card mb-2 p-4 p-sm-5">
            <div class="card-head d-flex flex-wrap align-items-center mb-2 mb-sm-7">
              ...
              <a class="btn btn-primary btn-small nav-item create"  href="<?= base_url('categoryC/form/-1')?>">
              ...
              <div class="row g-0">
                <div class="sheet-table d-table">
                    <div class="d-table-row">
                        ...
                        <div class="d-md-table-cell py-4 px-5 caption">Category Name</div>
                        <div class="d-none d-table-cell py-4 caption">Category Added</div>
                        <div class="d-table-cell py-3 caption">Action</div>

                    </div>
                    <?php 
                    $i = 1;
                    foreach ($dataCategoryC as $list): ?>
                    ...
                    <div class="d-table-row grid-markup">
                      ...
                      <div class="sheet-cell d-md-table-cell py-3 px-5">
                        <div class="badge large yellow"><?=$list->categoryc_name?></div>
                      </div>
                      <div class="sheet-cell d-none  d-table-cell py-3"><?=$list->categoryc_added?></div>
                      <div class="sheet-cell d-table-cell py-3 px-5 text-shades-2 text-base-2 text-nowrap">
                          <div class="btn-action-small me-5">
                              <a href="<?php echo base_url('categoryC/form/').$list->categoryc_id; ?>">
                                  <svg class="icon icon-edit">    
                                      <use xlink:href="#icon-edit"></use>
                                  </svg>
                              </a>
                               <a href="<?php echo base_url('categoryC/deleteCategory/').$list->categoryc_id; ?>"  onclick="return confirm('Are you sure you want to delete this category?');">
