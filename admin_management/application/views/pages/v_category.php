        ...
        <div class="page-body pb-4 pb-xl-6">
          <div class="card mb-2 p-4 p-sm-5">
            <div class="card-head d-flex flex-wrap align-items-center mb-2 mb-sm-7">
              ...
              <a class="btn btn-primary btn-small nav-item create"  href="<?= base_url('category/form/-1')?>">
                ...
                <div class="sheet-table d-table">
                    ...
                    <div class="d-table-row grid-markup">
                      ...
                      <div class="sheet-cell d-md-table-cell py-3 px-5">
                        <div class="badge large yellow"><?=$list->category_name?></div>
                      </div>
                      <div class="sheet-cell d-none  d-table-cell py-3"><?=$list->category_added?></div>
                      <div class="sheet-cell d-table-cell py-3 px-5 text-shades-2 text-base-2 text-nowrap">
                          <div class="btn-action-small me-5">
                              <a href="<?php echo base_url('category/form/').$list->category_id; ?>">
                                  <svg class="icon icon-edit">    
                                      <use xlink:href="#icon-edit"></use>
                                  </svg>
                              </a>
                               <a href="<?php echo site_url('category/deleteCategory/').$list->category_id; ?>"  onclick="return confirm('Are you sure you want to delete this category?');">
